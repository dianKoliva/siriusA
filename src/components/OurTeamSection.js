...
const teamMembers = [
  ...
  { name: 'Uwineza Pacifique', description: 'A serene, brave, and fervent individual devoted to tackling Africa\'s unemployment crisis. I firmly believe in the transformative influence of positive change and am steadfastly on a mission to establish opportunities for all. Prioritizing practical solutions, my aim is to effect a significant impact and contribute to a more promising future for the continent  ', image: paccy},
  ...
  { name: 'Hirwa Walid', description: 'Ever cheerful and eager to accommodate others, she infuses the team with a lively atmosphere, and her wit is unmatched. As the tech lead, she oversees software development and UI design responsibilities within the team. Pretty\'s presence on the team has led to substantial transformations, contributing significantly to decision-making processes and the overall growth of the team.', image: walid },
  { name: 'Rania Irakabaho', description: 'Ever cheerful and eager to accommodate others, she infuses the team with a lively atmosphere, and her wit is unmatched. As the tech lead, she oversees software development and UI design responsibilities within the team. Pretty\'s presence on the team has led to substantial transformations, contributing significantly to decision-making processes and the overall growth of the team.', image: rania },
